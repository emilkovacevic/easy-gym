...
const Navbar = (props: Props) => {
  ...
  return (
<nav
  className={`capitalize justify-between p-2 relative z-10 dark:text-dark-nav_text text-light-nav_text font-semibold ${isSticky &&
...
>
  <div className="flex w-5/6 m-auto justify-between">
    ...
    {mobileNavMenu && (
      <motion.div
        className='mx-auto md:hidden bg-gray-400 p-4 absolute rounded-l-xl right-0 '
        initial='hidden'
        onClick={() => setMobileNavMenu((prev) => !prev)}
      ...
      >
            <ul className="h-full">
              <li className=" hover:text-light-nav_hover dark:hover:text-dark-nav_hover">
